...
void draw_version() {
  ...
  u8g.drawStr( 84, 63, "V 1.1.0 BETA");
...
//      A_stepper.rotate(3600);
      A_stepper.move(A_Chem*56L*A_MICROSTEPS); //KHL-SZ-S35 = 40, KHL-SZ-S24 = 54 these are constant forever
       A_stepper.disable();
     // delay(1000);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void waterFill(unsigned long  water){
   ...
   delay(water*14L);//assume 4L per min -> 15000msec per 1000mL || 5L per min -> 12000msec per 1000mL
   servo1.writeMicroseconds(1000);   
}
////////////////////////////////////////////////////////////////////////////////////////////////////////
void buzz_1(){
