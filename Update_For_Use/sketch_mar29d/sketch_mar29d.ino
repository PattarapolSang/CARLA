...
void Update_Current_A(){
    ...
    Current_A       = (Current_A_Flt.get() * 0.0269) - 13.57 + Offset_Current_A;
...
void Update_Current_B(){
    ...
    Current_B       = (Current_B_Flt.get() * 0.028) - 13.753 + Offset_Current_B;
