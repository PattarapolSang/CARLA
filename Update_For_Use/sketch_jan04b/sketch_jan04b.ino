...
#define         PWM_C_PIN           6
//#define         ENABLE_MT_C_HPIN    12
//#define         ENABLE_MT_C_LPIN    13

#define         YELLOW_PUMP_PIN     10

#define         FlowSensor_PIN      8
...
unsigned long   WATER_A     =   2000000;
unsigned long   WATER_B     =   500000;
...
void setup() {
    ...
    //digitalWrite(ENABLE_MT_C_HPIN, HIGH);
    //digitalWrite(ENABLE_MT_C_HPIN, LOW);
...
void Motor_C_Request(int flow){
    int PWM_Request =   map(flow, MIN_FLOW_RATE, MAX_FLOW_RATE, 0, 255);
    //PumpMtrDrive.writeMicroseconds(PWM_Request);
    //Serial.println("PWM Request = " + String(PWM_Request));
    analogWrite(PWM_C_PIN ,PWM_Request);
}
